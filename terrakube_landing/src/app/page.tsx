...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-8 pb-20 gap-16 sm:p-20 overflow-auto">
      <main className="flex flex-col gap-8 items-center w-full max-w-7xl">
        ...
        ======================================== */}
        <div className="hero-section relative-container">
        ...
        <div className="feature-section">
          ...
          <hr className="border-t-2 border-gray-300  w-[900px] mx-auto" />
