...
export default function Home() {
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center p-8 pb-20 gap-16 sm:p-20 overflow-auto">      <main className="flex flex-col gap-8 items-center w-full max-w-7xl">
